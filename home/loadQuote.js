let quotes = ["Item in index 0 is not in use.", "War does not determine who is right - only who is left.",
	...
	`<a href="javascript:void(0);" onclick="ldch();" style="text-decoration: none; color: purple;">I'd save hundreds of hours if I could skip YouTube ads the moment they appear like you can do by clicking me!</a>`,
